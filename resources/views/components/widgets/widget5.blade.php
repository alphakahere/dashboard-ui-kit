<div class=" bg-white p-5 rounded-xl w-full">
   ...
   <div class="mt-3 h-full">
      <div class="flex items-end w-full flex-1 justify-between">
         <div class="h-44 w-4 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-56 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-32 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-52 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-44 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-56 bg-cyellow rounded-xl"></div>   
         <div class="h-64 w-4 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-32 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-32 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-52 bg-cyellow rounded-xl"></div>
         <div class="w-4 h-44 bg-cyellow rounded-xl"></div>

    ...
    <div class="flex items-center ">
       <div class="flex items-center">
          <div class="relative">
             ...
             <span class="h-3 w-3 a rounded-full bg-green-500 absolute top-6 right-1"></span>
          </div>
          <x-avatar class="" src="{{asset('images/djeynaba.jpeg')}}"/>
          <x-avatar src="{{asset('images/kalika.jpeg')}}"/>
       </div>
       <div class="flex items-center bg-purpleprimary w-10 h-10 justify-center rounded-full">
